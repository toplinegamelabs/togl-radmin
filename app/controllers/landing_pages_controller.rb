class LandingPagesController < ApplicationController
  ...
  def new
    @landing_page_templates = RapiManager.new.list_landing_page_templates
  ...
  def edit
    ...
    landing_page_hash = RapiManager.new.show_landing_page(params[:id])
  ...
  def update
    ...
    if is_json?(params[:template_variables])
      ...
      update_response = RapiManager.new.update_landing_page(params[:id], landing_page_params.to_json)
  ...
  def create
    ...
    if is_json?(params[:template_variables])
      ...
      create_response = RapiManager.new.create_landing_page(landing_page_params.to_json)
